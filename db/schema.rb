...
ActiveRecord::Schema[7.2].define(version: 2025_03_07_152652) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["user_plan_id"], name: "index_comments_on_user_plan_id"
  end
  ...
  create_table "exercises_plans", force: :cascade do |t|
    t.bigint "exercise_id", null: false
    t.bigint "plan_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["exercise_id"], name: "index_exercises_plans_on_exercise_id"
    t.index ["plan_id"], name: "index_exercises_plans_on_plan_id"
  end
